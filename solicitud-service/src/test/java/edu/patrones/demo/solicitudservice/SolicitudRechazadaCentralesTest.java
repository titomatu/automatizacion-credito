...
public class SolicitudRechazadaCentralesTest {
    ...
    @Test
    public void testSolicitudRechazadaRNEC() throws InterruptedException {
        //Login
        Thread.sleep(3000);
        ...
        username.clear();
        username.sendKeys("12345678912");

        WebElement password = driver.findElement(By.name("password"));
        password.clear();
        password.sendKeys("MWuBgSjr");
        ...
        numeroDocumento.sendKeys("12345678912");
        ...
        try{
            preparedStatement.setString(1, "12345678912");
