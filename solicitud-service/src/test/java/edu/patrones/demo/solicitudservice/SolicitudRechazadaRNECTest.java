...
public class SolicitudRechazadaRNECTest {
    ...
    public void testSolicitudRechazadaRNEC() throws InterruptedException {
        ...
        username.clear();
        username.sendKeys("123456799");

        WebElement password = driver.findElement(By.name("password"));
        password.clear();
        password.sendKeys("GFuYouc4");
        ...
        numeroDocumento.sendKeys("123456799");
        ...
        try{
            preparedStatement.setLong(1, 123456799);
